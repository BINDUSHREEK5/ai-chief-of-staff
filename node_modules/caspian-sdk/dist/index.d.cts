...
declare class Message {
     ...
     */
    stream(throttleMs?: number): StreamResponse;
}
/**
...
declare class StreamResponse {
    ...
    private replyAttempted;
    private pending;
    constructor(client: CommClient, messageId: string, channel: string, throttleMs?: number);
    get text(): string;
    get supportsEdit(): boolean;
    append(chunk: string): Promise<void>;
    close(): Promise<void>;
    private sendIfNeeded;
    private editWithRetry;
    private flush;
}
/**
...
declare class CommClient {
     ...
     */
    connectZulip(opts: ConnectOptions & {
        botEmail: string;
        botApiKey: string;
        serverUrl: string;
        botToken?: string;
     ...
     */
    handleWebhook(opts: HandleWebhookOptions): Promise<WebhookResult>;
}
...
declare class WebhookVerificationError extends CommError {
